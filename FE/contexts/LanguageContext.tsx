...
const translations: Record<string, Record<string, string>> = {
  vi: {
    ...
    "profile.on": "Bật",
    "profile.off": "Tắt",
    "profile.about": "Giới thiệu eLearnViet",
    "lessons.title": "Bài học",
    "lessons.info": "Học các bài học tiếng Việt cơ bản.",
  ...
  en: {
    ...
    "profile.on": "On",
    "profile.off": "Off",
    "profile.about": "About eLearnViet",
    "lessons.title": "Lessons",
    "lessons.info": "Learn basic Vietnamese lessons.",
  ...
  ko: {
    ...
    "profile.on": "켜기",
    "profile.off": "끄기",
    "profile.about": "eLearnViet 소개",
    "lessons.title": "레슨",
    "lessons.info": "베트남어 기본 레슨을 배우세요.",
    "quizzes.title": "퀴즈",
  ...
  ja: {
    ...
    "profile.on": "オン",
    "profile.off": "オフ",
    "profile.about": "eLearnViet 紹介",
    "lessons.info": "ベトナム語の基本レッスンを学びましょう。",
    "lessons.title": "レッスン",
    "quizzes.title": "クイズ",
  ...
  zh: {
    ...
    "profile.on": "开启",
    "profile.off": "关闭",
    "profile.about": "关于 eLearnViet",
    "lessons.title": "课程",
    "lessons.info": "学习越南语的基本课程。",
    "quizzes.title": "测验",
    "dashboard.title": "仪表板",
